    ...
    <div className="min-h-screen w-screen flex text-white bg-black font-sans">
      ...
      <aside className="w-60 bg-gradient-to-b from-zinc-900 to-red-900 p-4 border border-gray-200">
        ...
        <nav className="flex flex-col gap-7  text-sm">
          <a href="#" className="text-xl text-white visited:text-white no-underline"
          >compoentst</a>
          <a href="#" className=" text-xl text-white visited:text-white no-underline">Home</a>
          <a href="#" className=" text-xl text-white visited:text-white no-underline">takhsja</a>
          <a href="#" className=" text-xl text-white visited:text-white no-underline">sdfdsds</a>
          <a href="#" className=" text-xl text-white visited:text-white no-underline">adsfasdfad</a>
          <a href="#" className=" text-xl text-white visited:text-white no-underline">sdafdsafads</a>
          <a href="profile" className=" text-xl text-white visited:text-white no-underline">profile</a>
          <a href="#" className=" text-xl text-white visited:text-white no-underline">fasdfasdfasd</a>
        </nav>
      </aside>
      {/* Main Content */}
